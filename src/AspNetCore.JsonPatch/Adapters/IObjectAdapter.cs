...
namespace AspNetCore.JsonPatch.Adapters
{
    ...
    public interface IObjectAdapter
    {
        ...
        /// <param name="objectType">The type of the object to apply the operations to.</param>
        void Add(Operation operation, object objectToApplyTo, Type objectType);
        ...
        /// <param name="objectToApplyTo">Object to apply the operation to.</param>
        /// <param name="objectType">The type of the object to apply the operations to.</param>
        void Copy(Operation operation, object objectToApplyTo, Type objectType);
        ...
        /// <param name="objectToApplyTo">Object to apply the operation to.</param>
        /// <param name="objectType">The type of the object to apply the operations to.</param>
        void Move(Operation operation, object objectToApplyTo, Type objectType);
        ...
        /// <param name="objectToApplyTo">Object to apply the operation to.</param>
        /// <param name="objectType">The type of the object to apply the operations to.</param>
        void Remove(Operation operation, object objectToApplyTo, Type objectType);
        ...
        /// <param name="objectToApplyTo">Object to apply the operation to.</param>
        /// <param name="objectType">The type of the object to apply the operations to.</param>
        void Replace(Operation operation, object objectToApplyTo, Type objectType);
    }
}
